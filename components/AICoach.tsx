...
export default function AICoach() {
  ...
  return (
    <div className="bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 dark:from-indigo-600 dark:via-purple-600 dark:to-pink-600 rounded-3xl shadow-lg p-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-[#f2f0e3]/10 to-transparent pointer-events-none"></div>
      ...
      <div className="relative z-10">
        ...
        {insights && !isEditing && (
          <div className="bg-[#f2f0e3]/95 dark:bg-[#f2f0e3]/90 rounded-2xl p-5 shadow-lg">
